...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="index.jsp?id=-1&pid=1"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">GST Application</span></a></li>
        <li><a class="app-menu__item active" href="client.jsp?id=-1&pid=1"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Client</span></a></li>
        <li><a class="app-menu__item active" href="change_password.jsp"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Change Password</span></a></li>
