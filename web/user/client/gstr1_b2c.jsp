<!DOCTYPE html>
<%
    if((String)session.getAttribute("gstno")=="" || (String)session.getAttribute("gstno")==null)
    {
              ...
              <form method="post" onsubmit="return validate();" name="form" class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="gstno" type="text" name="gstno" placeholder="Enter GST Number" aria-describedby="emailHelp" value="Nil" readonly="">
                    <small class="error" id="gn"></small>
                  </div>
    			  <div class="form-group">
                    <label for="exampleInputEmail1">Invoice Number</label>
                    <input class="form-control" id="ino" type="text" 
                    name="ino" placeholder="Enter Invoice Number" aria-describedby="emailHelp" value="Nil" readonly="">
                    <small class="error" id="in"></small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Invoice Date</label>
                    <input class="form-control" id="idate" type="date" 
                    name="idate" value="Nil" >
